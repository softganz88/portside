...
Releases: v0.1.0, v0.1.1 and v0.1.2 on GitHub (`softganz88/portside`). v0.1.2 is the first with the repacked AppImage (mixed compression); the fully uncompressed repack is not released yet.
