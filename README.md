...
```sh
sudo apt install ./src-tauri/target/release/bundle/deb/Portside_0.1.4_amd64.deb   # then launch "Portside" from the menu
# or, without installing:
./src-tauri/target/release/bundle/appimage/Portside_0.1.4_amd64.AppImage
```
